class MyCalc:
    ...
    def add(self, num1, num2):
        ...
        """This function adds two numbers or utilizes the previous answer (ans) and add it to the number."""
        if num1 == "ans":
    ...
    def sub(self, num1, num2):
        """Name: Bhavya Shah; UCID: bs635; Date: 15 October, 2023"""
        """This function substracts two numbers or utilizes the previous answer (ans) and substract it to the num."""
        if num1 == "ans":
    ...
    def mult(self, num1, num2):
        """Name: Bhavya Shah; UCID: bs635; Date: 15 October, 2023"""
        """This function multiplies two numbers or utilizes the previous answer (ans) and multiply it to the number."""
        if num1 == "ans":
    ...
    def div(self, num1, num2):
        """Name: Bhavya Shah; UCID: bs635; Date: 15 October, 2023"""
        """This function divides two numbers or utilizes the previous answer (ans) and divide it to the number."""
        if num1 == "ans":
